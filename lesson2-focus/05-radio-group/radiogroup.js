  ...
  RadioGroup.prototype.handleKeyDown = function(e) {
    switch(e.keyCode) {
      ...
      case VK_LEFT: {
        ...
        if (this.buttons.indexOf(this.focusedButton) !== 0) {
          this.focusedIdx = this.buttons.indexOf(this.focusedButton) - 1;
      ...
      case VK_RIGHT: {
        ...
        // This seems like a good place to do some stuff :)
        if (this.buttons.indexOf(this.focusedButton) !== this.buttons.length - 1) {
          this.focusedIdx = this.buttons.indexOf(this.focusedButton) + 1;
